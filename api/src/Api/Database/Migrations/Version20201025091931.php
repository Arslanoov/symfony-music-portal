...
final class Version20201025091931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_users ADD sign_up_confirm_token_expire_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL');
        $this->addSql('COMMENT ON COLUMN user_users.sign_up_confirm_token_expire_date IS \'(DC2Type:datetime_immutable)\'');
    }
