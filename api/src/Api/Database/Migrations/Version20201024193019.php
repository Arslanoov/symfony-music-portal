...
final class Version20201024193019 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE user_users (id UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT ' .
            'TIME ZONE NOT NULL, login VARCHAR(16) NOT NULL, email VARCHAR(32) NOT NULL, age INT NOT NULL, ' .
            'password VARCHAR(128) NOT NULL, name_first VARCHAR(32) NOT NULL, name_last VARCHAR(32) NOT NULL, ' .
            'PRIMARY KEY(id))');
